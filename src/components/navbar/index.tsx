...
const Navbar = () => {
  ...
  return (
      ...
      <div className={`${isOpen ? 'h-full' : 'md:h-full h-0'} overflow-hidden`}>
        <div className="flex list-none gap-2 md:h-full h-auto  md:flex-row flex-col">
          ...
          <NavLink to="/contact" className={ ({ isActive }) => isActive ? " text-[#D76A03] border-b-4 border-[#D76A03] h-[100px] px-8 flex items-center" : " h-[100px] px-8 flex items-center"}>Contact</NavLink>
